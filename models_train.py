...
if __name__ == '__main__':
    ...
    # model = (YOLO(r'cfg/models/11/yolo11.yaml')
    #          .load(r"E:\PProject\ultralytics-main\ultralytics-main\ultralytics\runs\train\exp6\weights\best.pt"))  # 使用预训练权重训练
    # 训练参数 ----------------------------------------------------------------------------------------------
    model.train(
        data='/root/dataset_0189862/data.yaml',
        ...
        device='cuda',  # (int | str | list, optional) 运行的设备，例如 cuda device=0 或 device=0,1,2,3 或 device=cpu
